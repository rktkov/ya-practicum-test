...
# Если скрипт запущен с неполным наборо аргументов командной строки, то списки считываются из файлов по умолчанию, которые дожны быть в одном катологе со скриптом.
